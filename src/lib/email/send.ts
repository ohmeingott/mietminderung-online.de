...
export async function sendEmail(params: {
  ...
  // The fallback is a last resort for local runs; in production EMAIL_FROM has
  // to name an address on the domain verified with Resend, or every send is
  // refused. Not a "noreply" address on purpose — this carries a contract
  // confirmation, and a customer replying to it must reach someone. reply_to
  // below points at the operator either way.
  const from =
