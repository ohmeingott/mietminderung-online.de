...
export const translations: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "flow.chapter.check": "Anspruch prüfen",
    "flow.chapter.letter": "Mängelanzeige",
    "flow.stepOf": "Schritt {n} von {total}",
    "letter.step.frist": "Frist",
    "wizard.railHeading": "Ihr Fortschritt",
    ...
    "wizard.summaryTitle": "Ihr Zwischenstand",
    "wizard.sumQuote": "Minderung",
    "wizard.sumSaving": "pro Monat",
    "wizard.sumDeadline": "Frist bis",
    "wizard.trust1": "Kostenlos und ohne Registrierung",
    "wizard.trust2": "Basierend auf echten Gerichtsurteilen",
    "wizard.trust3": "In etwa drei Minuten fertig",
  ...
  en: {
    ...
    // Wizard, Frist und "Wie geht es weiter?"
    "flow.chapter.check": "Check your claim",
    "flow.chapter.letter": "Defect notice",
    "flow.stepOf": "Step {n} of {total}",
    "letter.step.frist": "Deadline",
    "wizard.railHeading": "Your progress",
    ...
    "wizard.summaryTitle": "Where you stand",
    "wizard.sumQuote": "Reduction",
    "wizard.sumSaving": "per month",
    "wizard.sumDeadline": "Deadline",
    "wizard.trust1": "Free, no sign-up",
    "wizard.trust2": "Based on real court rulings",
    "wizard.trust3": "Done in about three minutes",
  ...
  tr: {
    ...
    // Wizard, Frist und "Wie geht es weiter?"
    "flow.chapter.check": "Hak kontrolü",
    "flow.chapter.letter": "Kusur bildirimi",
    "flow.stepOf": "Adım {n} / {total}",
    "letter.step.frist": "Süre",
    "wizard.railHeading": "İlerlemeniz",
    ...
    "wizard.summaryTitle": "Mevcut durumunuz",
    "wizard.sumQuote": "İndirim",
    "wizard.sumSaving": "aylık",
    "wizard.sumDeadline": "Son tarih",
    "wizard.trust1": "Ücretsiz, kayıt gerekmez",
    "wizard.trust2": "Gerçek mahkeme kararlarına dayanır",
    "wizard.trust3": "Yaklaşık üç dakikada hazır",
  ...
  uk: {
    ...
    // Wizard, Frist und "Wie geht es weiter?"
    "flow.chapter.check": "Перевірка права",
    "flow.chapter.letter": "Повідомлення про недоліки",
    "flow.stepOf": "Крок {n} з {total}",
    "letter.step.frist": "Строк",
    "wizard.railHeading": "Ваш поступ",
    ...
    "wizard.summaryTitle": "Ваш проміжний підсумок",
    "wizard.sumQuote": "Зниження",
    "wizard.sumSaving": "на місяць",
    "wizard.sumDeadline": "Строк до",
    "wizard.trust1": "Безкоштовно, без реєстрації",
    "wizard.trust2": "На основі реальних судових рішень",
    "wizard.trust3": "Готово приблизно за три хвилини",
  ...
  ru: {
    ...
    // Wizard, Frist und "Wie geht es weiter?"
    "flow.chapter.check": "Проверка права",
    "flow.chapter.letter": "Уведомление о недостатках",
    "flow.stepOf": "Шаг {n} из {total}",
    "letter.step.frist": "Срок",
    "wizard.railHeading": "Ваш прогресс",
    ...
    "wizard.summaryTitle": "Ваш промежуточный итог",
    "wizard.sumQuote": "Снижение",
    "wizard.sumSaving": "в месяц",
    "wizard.sumDeadline": "Срок до",
    "wizard.trust1": "Бесплатно, без регистрации",
    "wizard.trust2": "На основе реальных судебных решений",
    "wizard.trust3": "Готово примерно за три минуты",
  ...
  ar: {
    ...
    // Wizard, Frist und "Wie geht es weiter?"
    "flow.chapter.check": "التحقق من الحق",
    "flow.chapter.letter": "إشعار العيوب",
    "flow.stepOf": "الخطوة {n} من {total}",
    "letter.step.frist": "المهلة",
    "wizard.railHeading": "تقدّمك",
    ...
    "wizard.summaryTitle": "وضعك الحالي",
    "wizard.sumQuote": "التخفيض",
    "wizard.sumSaving": "شهريًا",
    "wizard.sumDeadline": "المهلة حتى",
    "wizard.trust1": "مجانًا وبدون تسجيل",
    "wizard.trust2": "استنادًا إلى أحكام قضائية حقيقية",
    "wizard.trust3": "جاهز في نحو ثلاث دقائق",
  ...
  pl: {
    ...
    // Wizard, Frist und "Wie geht es weiter?"
    "flow.chapter.check": "Sprawdzenie roszczenia",
    "flow.chapter.letter": "Zgłoszenie usterek",
    "flow.stepOf": "Krok {n} z {total}",
    "letter.step.frist": "Termin",
    "wizard.railHeading": "Twój postęp",
    ...
    "wizard.summaryTitle": "Twój bieżący stan",
    "wizard.sumQuote": "Obniżka",
    "wizard.sumSaving": "miesięcznie",
    "wizard.sumDeadline": "Termin do",
    "wizard.trust1": "Bezpłatnie i bez rejestracji",
    "wizard.trust2": "Na podstawie prawdziwych wyroków sądowych",
    "wizard.trust3": "Gotowe w około trzy minuty",
