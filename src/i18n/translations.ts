...
export const translations: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "how.s4.title": "Brief versenden",
    "how.s4.desc":
      "Laden Sie den Brief herunter, erhalten Sie ihn per E-Mail — oder wir versenden ihn per Post direkt an Ihren Vermieter.",
    ...
    "letter.signature": "Digitale Unterschrift (optional — nur für Postversand nötig)",
    ...
    "letter.howReceive": "Wie möchten Sie den Brief erhalten?",
    "letter.chooseOption": "Wählen Sie Ihre bevorzugte Option.",
    "letter.download": "Herunterladen",
    "letter.downloadDesc": "Laden Sie den Brief als PDF herunter und drucken Sie ihn selbst aus.",
    "letter.free": "Kostenlos",
    "letter.emailOption": "Per E-Mail",
    "letter.emailDesc": "Wir senden Ihnen den Brief als PDF an Ihre E-Mail-Adresse.",
    "letter.postOption": "Per Post versenden",
    "letter.postDesc":
      "Wir drucken, frankieren und versenden den Brief per Einschreiben direkt an Ihren Vermieter.",
    "letter.recommended": "Empfohlen",
    "letter.from": "Ab",
    ...
    "letter.emailSendTo": "Der Brief wird als PDF an",
    "letter.emailSent": "gesendet.",
    "letter.emailSentSuccess": "Brief wurde an {email} gesendet!",
    "letter.checkSpam": "Bitte überprüfen Sie auch Ihren Spam-Ordner.",
    "letter.sending": "Wird gesendet...",
    "letter.sendEmail": "Brief als PDF per E-Mail senden",
    "letter.postInfo":
      "Wir drucken Ihren Brief, frankieren ihn und versenden ihn als Einwurf-Einschreiben an Ihren Vermieter",
    "letter.postVia": "Postversand via eBrief.de:",
    "letter.addSignature": "Bitte gehen Sie zurück und fügen Sie Ihre digitale Unterschrift hinzu.",
    "letter.inclShipping": "inkl. Druck, Frankierung und Einwurf-Einschreiben",
    "letter.sendPost": "Jetzt kostenpflichtig versenden",
    "letter.postSending": "Wird versendet...",
    "letter.postSent": "Brief wurde zum Versand übergeben!",
    "letter.postSentDesc":
      "Ihr Brief wird gedruckt und als Einwurf-Einschreiben an {name} versendet.",
    "letter.postConfirm": "Sie erhalten eine Bestätigung an {email}",
    "letter.postSecure": "Versand über eBrief.de / PIN AG — verschlüsselt und sicher",
    "letter.warning":
    ...
    "teaser.feat3": "Download, E-Mail oder Postversand",
  ...
  tr: {
    ...
    "how.s4.title": "Mektup gönder",
    "how.s4.desc": "Mektubu indirin, e-posta ile alın — veya posta ile doğrudan ev sahibinize gönderin.",
    ...
    "letter.signature": "Dijital imza (opsiyonel — yalnızca posta gönderimi için gerekli)",
    ...
    "letter.howReceive": "Mektubu nasıl almak istersiniz?",
    "letter.chooseOption": "Tercih ettiğiniz seçeneği seçin.",
    "letter.download": "İndir",
    "letter.downloadDesc": "Mektubu PDF olarak indirin ve kendiniz yazdırın.",
    "letter.free": "Ücretsiz",
    "letter.emailOption": "E-posta ile",
    "letter.emailDesc": "Mektubu PDF olarak e-posta adresinize gönderiyoruz.",
    "letter.postOption": "Posta ile gönder",
    "letter.postDesc": "Mektubu yazdırıp taahhütlü olarak doğrudan ev sahibinize gönderiyoruz.",
    "letter.recommended": "Önerilen",
    "letter.from": "den itibaren",
    ...
    "letter.emailSendTo": "Mektup PDF olarak şu adrese gönderilecek:",
    "letter.emailSent": "gönderildi.",
    "letter.emailSentSuccess": "Mektup {email} adresine gönderildi!",
    "letter.checkSpam": "Lütfen spam klasörünüzü de kontrol edin.",
    "letter.sending": "Gönderiliyor...",
    "letter.sendEmail": "PDF olarak e-posta ile gönder",
    "letter.postInfo": "Mektubunuzu yazdırıp taahhütlü posta olarak ev sahibinize gönderiyoruz",
    "letter.postVia": "eBrief.de üzerinden posta gönderimi:",
    "letter.addSignature": "Lütfen geri dönüp dijital imzanızı ekleyin.",
    "letter.inclShipping": "Baskı, posta ücreti ve taahhütlü gönderim dahil",
    "letter.sendPost": "Şimdi ücretli olarak gönder",
    "letter.postSending": "Gönderiliyor...",
    "letter.postSent": "Mektup gönderime teslim edildi!",
    "letter.postSentDesc": "Mektubunuz yazdırılıp taahhütlü olarak {name} adresine gönderilecek.",
    "letter.postConfirm": "{email} adresine onay alacaksınız",
    "letter.postSecure": "eBrief.de / PIN AG üzerinden gönderim — şifreli ve güvenli",
    ...
    "teaser.feat3": "İndirme, e-posta veya posta gönderimi",
  ...
  uk: {
    ...
    "how.s4.title": "Надішліть лист",
    "how.s4.desc": "Завантажте лист, отримайте його електронною поштою — або ми надішлемо його поштою безпосередньо орендодавцю.",
    ...
    "letter.signature": "Цифровий підпис (необов'язково — лише для поштового відправлення)",
    ...
    "letter.howReceive": "Як ви хочете отримати лист?",
    "letter.chooseOption": "Оберіть бажаний варіант.",
    "letter.download": "Завантажити",
    "letter.downloadDesc": "Завантажте лист як PDF і роздрукуйте самостійно.",
    "letter.free": "Безкоштовно",
    "letter.emailOption": "Електронною поштою",
    "letter.emailDesc": "Ми надішлемо вам лист як PDF на вашу електронну пошту.",
    "letter.postOption": "Надіслати поштою",
    "letter.postDesc": "Ми друкуємо, франкуємо і надсилаємо лист рекомендованим листом безпосередньо орендодавцю.",
    "letter.recommended": "Рекомендовано",
    "letter.from": "від",
    ...
    "letter.emailSendTo": "Лист як PDF буде надіслано на",
    "letter.emailSent": "надіслано.",
    "letter.emailSentSuccess": "Лист надіслано на {email}!",
    "letter.checkSpam": "Перевірте також папку спам.",
    "letter.sending": "Надсилається...",
    "letter.sendEmail": "Надіслати лист як PDF електронною поштою",
    "letter.postInfo": "Ми друкуємо ваш лист і надсилаємо його рекомендованим листом орендодавцю",
    "letter.postVia": "Поштове відправлення через eBrief.de:",
    "letter.addSignature": "Поверніться назад і додайте цифровий підпис.",
    "letter.inclShipping": "Включаючи друк, франкування та рекомендований лист",
    "letter.sendPost": "Надіслати за плату зараз",
    "letter.postSending": "Надсилається...",
    "letter.postSent": "Лист передано на відправку!",
    "letter.postSentDesc": "Ваш лист буде надруковано та надіслано рекомендованим листом на адресу {name}.",
    "letter.postConfirm": "Ви отримаєте підтвердження на {email}",
    "letter.postSecure": "Відправка через eBrief.de / PIN AG — зашифровано та безпечно",
    ...
    "teaser.feat3": "Завантаження, електронна пошта або поштове відправлення",
  ...
  ru: {
    ...
    "how.s4.title": "Отправьте письмо",
    "how.s4.desc": "Скачайте письмо, получите по электронной почте — или мы отправим его почтой арендодателю.",
    ...
    "letter.signature": "Цифровая подпись (необязательно — только для почтовой отправки)",
    ...
    "letter.howReceive": "Как вы хотите получить письмо?",
    "letter.chooseOption": "Выберите предпочтительный вариант.",
    "letter.download": "Скачать",
    "letter.downloadDesc": "Скачайте письмо как PDF и распечатайте сами.",
    "letter.free": "Бесплатно",
    "letter.emailOption": "По электронной почте",
    "letter.emailDesc": "Мы отправим вам письмо как PDF на вашу электронную почту.",
    "letter.postOption": "Отправить почтой",
    "letter.postDesc": "Мы печатаем и отправляем письмо заказным письмом арендодателю.",
    "letter.recommended": "Рекомендуется",
    "letter.from": "от",
    ...
    "letter.emailSendTo": "Письмо как PDF будет отправлено на",
    "letter.emailSent": "отправлено.",
    "letter.emailSentSuccess": "Письмо отправлено на {email}!",
    "letter.checkSpam": "Проверьте также папку спам.",
    "letter.sending": "Отправляется...",
    "letter.sendEmail": "Отправить PDF по электронной почте",
    "letter.postInfo": "Мы печатаем ваше письмо и отправляем заказным письмом арендодателю",
    "letter.postVia": "Почтовая отправка через eBrief.de:",
    "letter.addSignature": "Вернитесь назад и добавьте цифровую подпись.",
    "letter.inclShipping": "Включая печать, франкировку и заказное письмо",
    "letter.sendPost": "Отправить платно сейчас",
    "letter.postSending": "Отправляется...",
    "letter.postSent": "Письмо передано на отправку!",
    "letter.postSentDesc": "Ваше письмо будет напечатано и отправлено заказным на адрес {name}.",
    "letter.postConfirm": "Вы получите подтверждение на {email}",
    "letter.postSecure": "Отправка через eBrief.de / PIN AG — зашифровано и безопасно",
    ...
    "teaser.feat3": "Скачивание, электронная почта или почтовая отправка",
  ...
  ar: {
    ...
    "how.s4.title": "أرسل الرسالة",
    "how.s4.desc": "حمّل الرسالة أو استلمها بالبريد الإلكتروني — أو نرسلها بالبريد مباشرة للمؤجر.",
    ...
    "letter.signature": "توقيع رقمي (اختياري — مطلوب فقط للإرسال البريدي)",
    "letter.clearSig": "مسح",
    ...
    "letter.howReceive": "كيف تريد استلام الرسالة؟",
    "letter.chooseOption": "اختر الخيار المفضل.",
    "letter.download": "تحميل",
    "letter.downloadDesc": "حمّل الرسالة كـ PDF واطبعها بنفسك.",
    "letter.free": "مجاني",
    "letter.emailOption": "بالبريد الإلكتروني",
    "letter.emailDesc": "نرسل لك الرسالة كـ PDF على بريدك الإلكتروني.",
    "letter.postOption": "إرسال بالبريد",
    "letter.postDesc": "نطبع الرسالة ونرسلها بالبريد المسجل مباشرة للمؤجر.",
    "letter.recommended": "موصى به",
    "letter.from": "من",
    "letter.downloadPdf": "تحميل كـ PDF",
    "letter.downloadTxt": "كملف نصي",
    "letter.copyText": "نسخ النص",
    "letter.copied": "تم النسخ!",
    "letter.emailSendTo": "سيتم إرسال الرسالة كـ PDF إلى",
    "letter.emailSent": "تم الإرسال.",
    "letter.emailSentSuccess": "تم إرسال الرسالة إلى {email}!",
    "letter.checkSpam": "يرجى التحقق من مجلد البريد غير المرغوب.",
    "letter.sending": "جارٍ الإرسال...",
    "letter.sendEmail": "إرسال الرسالة كـ PDF بالبريد الإلكتروني",
    "letter.postInfo": "نطبع رسالتك ونرسلها بالبريد المسجل للمؤجر",
    "letter.postVia": "إرسال بريدي عبر eBrief.de:",
    "letter.addSignature": "يرجى العودة وإضافة توقيعك الرقمي.",
    "letter.inclShipping": "شامل الطباعة والشحن والبريد المسجل",
    "letter.sendPost": "إرسال مدفوع الآن",
    "letter.postSending": "جارٍ الإرسال...",
    "letter.postSent": "تم تسليم الرسالة للإرسال!",
    "letter.postSentDesc": "سيتم طباعة رسالتك وإرسالها بالبريد المسجل إلى {name}.",
    "letter.postConfirm": "ستتلقى تأكيداً على {email}",
    "letter.postSecure": "الإرسال عبر eBrief.de / PIN AG — مشفر وآمن",
    ...
    "teaser.feat3": "تحميل أو بريد إلكتروني أو إرسال بريدي",
  ...
  pl: {
    ...
    "how.s4.title": "Wyślij list",
    "how.s4.desc": "Pobierz list, otrzymaj go e-mailem — lub wyślemy go pocztą do wynajmującego.",
    ...
    "letter.signature": "Podpis cyfrowy (opcjonalnie — wymagany tylko do wysyłki pocztowej)",
    ...
    "letter.howReceive": "Jak chcesz otrzymać list?",
    "letter.chooseOption": "Wybierz preferowaną opcję.",
    "letter.download": "Pobierz",
    "letter.downloadDesc": "Pobierz list jako PDF i wydrukuj samodzielnie.",
    "letter.free": "Bezpłatnie",
    "letter.emailOption": "E-mailem",
    "letter.emailDesc": "Wyślemy Ci list jako PDF na Twój adres e-mail.",
    "letter.postOption": "Wyślij pocztą",
    "letter.postDesc": "Drukujemy i wysyłamy list listem poleconym do wynajmującego.",
    "letter.recommended": "Zalecane",
    "letter.from": "od",
    ...
    "letter.emailSendTo": "List jako PDF zostanie wysłany na",
    "letter.emailSent": "wysłano.",
    "letter.emailSentSuccess": "List wysłany na {email}!",
    "letter.checkSpam": "Sprawdź również folder spam.",
    "letter.sending": "Wysyłanie...",
    "letter.sendEmail": "Wyślij PDF e-mailem",
    "letter.postInfo": "Drukujemy Twój list i wysyłamy go listem poleconym do wynajmującego",
    "letter.postVia": "Wysyłka pocztowa przez eBrief.de:",
    "letter.addSignature": "Wróć i dodaj swój podpis cyfrowy.",
    "letter.inclShipping": "W tym druk, opłata pocztowa i list polecony",
    "letter.sendPost": "Wyślij płatnie teraz",
    "letter.postSending": "Wysyłanie...",
    "letter.postSent": "List przekazany do wysyłki!",
    "letter.postSentDesc": "Twój list zostanie wydrukowany i wysłany listem poleconym na adres {name}.",
    "letter.postConfirm": "Otrzymasz potwierdzenie na {email}",
    "letter.postSecure": "Wysyłka przez eBrief.de / PIN AG — szyfrowana i bezpieczna",
    ...
    "teaser.feat3": "Pobieranie, e-mail lub wysyłka pocztowa",
