...
export const translations: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "letter.detailDescPlaceholder": "Was genau ist kaputt oder beschädigt? Wo in der Wohnung?",
    "letter.sinceToday": "seit heute",
    "letter.sinceThisWeek": "diese Woche",
    "letter.sinceThisMonth": "diesen Monat",
    "letter.sinceLonger": "länger her",
  ...
  en: {
    ...
    "letter.detailDescPlaceholder": "What exactly is broken or damaged? Where in the flat?",
    "letter.sinceToday": "since today",
    "letter.sinceThisWeek": "this week",
    "letter.sinceThisMonth": "this month",
    "letter.sinceLonger": "longer ago",
  ...
  tr: {
    ...
    "letter.detailDescPlaceholder": "Tam olarak ne bozuk veya hasarlı? Dairenin neresinde?",
    "letter.sinceToday": "bugünden beri",
    "letter.sinceThisWeek": "bu hafta",
    "letter.sinceThisMonth": "bu ay",
    "letter.sinceLonger": "daha eski",
  ...
  uk: {
    ...
    "letter.detailDescPlaceholder": "Що саме зламано або пошкоджено? Де в квартирі?",
    "letter.sinceToday": "від сьогодні",
    "letter.sinceThisWeek": "цього тижня",
    "letter.sinceThisMonth": "цього місяця",
    "letter.sinceLonger": "давніше",
  ...
  ru: {
    ...
    "letter.detailDescPlaceholder": "Что именно сломано или повреждено? Где в квартире?",
    "letter.sinceToday": "с сегодняшнего дня",
    "letter.sinceThisWeek": "на этой неделе",
    "letter.sinceThisMonth": "в этом месяце",
    "letter.sinceLonger": "давно",
  ...
  ar: {
    ...
    "letter.detailDescPlaceholder": "ما الذي تعطل أو تضرر بالضبط؟ وأين في الشقة؟",
    "letter.sinceToday": "منذ اليوم",
    "letter.sinceThisWeek": "هذا الأسبوع",
    "letter.sinceThisMonth": "هذا الشهر",
    "letter.sinceLonger": "منذ فترة أطول",
  ...
  pl: {
    ...
    "letter.detailDescPlaceholder": "Co dokładnie jest zepsute lub uszkodzone? Gdzie w mieszkaniu?",
    "letter.sinceToday": "od dzisiaj",
    "letter.sinceThisWeek": "w tym tygodniu",
    "letter.sinceThisMonth": "w tym miesiącu",
    "letter.sinceLonger": "dawniej",
